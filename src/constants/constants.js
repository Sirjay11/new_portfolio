export const projects = [
...

  {
    ...
    description:
      "I built this expense tracker to help me budget my finances. It was built with React.It uses a third party API service called Speechly for the voice recognition process. ",
...
export const TimeLineData = [
  { year: 2020, text: 'Started my journey learning Python.' },
  {year: 2020, text: 'Then started to learn Web Development.'},
  {year: 2020, text: 'First i learned HTML,CSS,Javascript'},
  {year: 2021, text:'Then I moved on to learn React, NextJs, MongoDB and GraphQL.'},
  {year: 2022, text: 'Started to learn Blockchain Development and Smart Contract Development'},
];